...
/* CSS hover fallback keeps activation reliable during sticky-header repaints. */
.identity-navigation:hover .identity-links,
.identity-navigation:focus-within .identity-links { opacity: 1; visibility: visible; pointer-events: auto; transform: translateX(0) scaleX(1); }
