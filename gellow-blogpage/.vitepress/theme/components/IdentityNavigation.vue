...
<style scoped>
.identity-navigation { position: relative; flex-shrink: 0; z-index: 40; }
...
.is-open .identity-links { opacity: 1; visibility: visible; pointer-events: auto; transform: translateX(0) scaleX(1); }`r`n/* CSS hover fallback keeps activation reliable during sticky-header repaints. */`r`n.identity-navigation:hover .identity-links,`r`n.identity-navigation:focus-within .identity-links { opacity: 1; visibility: visible; pointer-events: auto; transform: translateX(0) scaleX(1); }
